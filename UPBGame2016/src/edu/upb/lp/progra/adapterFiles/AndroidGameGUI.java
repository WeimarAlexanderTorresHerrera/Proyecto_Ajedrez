...
public interface AndroidGameGUI {
	 ...
	 * @param textSize
	 */
	public void configureGrid(int numberOfRows, int numberOfColumns,
			int verticalSpacing, int horizontalSpacing, int textSize);

	/**
	 * Set the proportion of the bottom section, which contains the buttons and
	 * text messages. A proportion of 0.5 means that half of the screen will be
	 * taken by the grid and the other half by the buttons and text messages
	 * 
	 * @param proportion
	 */
	public void setBottomSectionProportion(double proportion);
	...
	/**
	 * Set the color of the text in the grid cell
	 * 
	 * @param horizontal
	 * @param vertical
	 * @param color
	 *            See {@link Color}
	 */
	public void setTextColorOnCell(int vertical, int horizontal, int color);
	 ...
	 * @param longMessage
	 *            true if the message should stay a long time (based on
	 *            Toast.LENGTH_LONG and Toast.LENGTH_SHORT)
	 */
	public void showTemporaryMessage(String message, boolean longMessage);
